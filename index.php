...
<aside>
  <div class="wrapper">
   ...
   $sayfasor = mysql_query("select * from sayfalar where sayfa_anasayfa = '1' order by sayfa_sira desc");
    ...
    <div class="box">
      ...
      <div class="box-bg maxheight">
        <div class="padding">
          ...
          <p><?php echo substr($sayfacek['sayfa_icerik'],0,250); ?></p>
        </div>
        <div class="aligncenter"> <a class="button" href="sayfa-detay.php?sayfa_id=<?php echo $sayfacek['sayfa_id'];?>">Devamnı Oku</a> </div>
      </div>
    </div>
  </div>
